<template>
  <NuxtLayout name="app">
    <div v-if="loading" class="container h-screen flex items-center justify-center py-24">
      <pulse-loader :loading="loading" :size="size"></pulse-loader>
    </div>
    <div v-if="!loading && movie" class="transition ease-in-out duration-300">
...
const {movie, errors, getMovie} = useMovies()
